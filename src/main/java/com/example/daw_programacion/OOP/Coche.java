...
public class Coche extends Vehiculo{
    ...
    public Coche(int numRuedas, String matriculo, boolean electrico, int capacidadMaletero) {
    ...
    public Coche(String matriculo, int numRuedas, int capacidadMaletero, boolean esElectrico) {
